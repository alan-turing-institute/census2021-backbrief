...
Some steps have already been taken to speed up the clerical matching process via a proposed *associative people matching* method, which has the side-effect if increasing the number of automatic matches. 
